...
OPS = {
  ...
  'skip_connect' : lambda C, stride, affine: Identity() if stride == 1 else nn.MaxPool1d(2, stride=stride, padding=0),
  ...
  'sep_conv_7x1' : lambda C, stride, affine: SepConv(C, C, 7, stride, 3, affine=affine),
  'dil_conv_3x1' : lambda C, stride, affine: DilConv(C, C, 3, stride, 2, 2, affine=affine),
  'dil_conv_5x1' : lambda C, stride, affine: DilConv(C, C, 5, stride, 4, 2, affine=affine),
  'conv_7x1_7x1' : lambda C, stride, affine: nn.Sequential(
...
def main():
  ...
  # op = DilConv(C, C, 3, stride, 2, 2, affine=affine)
  op = OPS["none"](C, stride, affine)
